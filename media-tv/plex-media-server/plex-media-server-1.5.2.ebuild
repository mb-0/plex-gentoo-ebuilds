...
pkg_postinst() {
    ...
    einfo "Version: 1.5.2.3557-029f6ffbf, March 29, 2017, Plex Pass Only."
    einfo ""
	einfo "Changes:"
    einfo " NEW:"
    einfo "  - (Web) Updated Plex Web to 3.2.0."
    einfo ""
    einfo " FIXES:"
    einfo "  - (Network) Slower than expected streaming over fast connections with high latency. (#6548)"
    einfo "  - (Transcoder) Playback failures during concurrent sessions (#6590)"
    einfo "  - (DVR) Older SiliconDust HDHomerun tuners weren't being detected on FreeBSD."
    einfo "  - (Localization) Updated server translation text."
    einfo ""
